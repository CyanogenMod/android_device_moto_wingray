...
public class DeviceSettings extends PreferenceActivity  {
    ...
    public static void restore(Context context) {
        ...
        if (Utils.fileExists(CHARGINGLED_FILE)) {
            String sDefaultValue = Utils.readSysfsLine(CHARGINGLED_FILE);
            Utils.writeValue(CHARGINGLED_FILE, sharedPrefs.getBoolean(KEY_CHARGINGLED, PREF_ENABLED.equals(sDefaultValue)));
        }
    }
}
